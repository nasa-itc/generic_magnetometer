...
void Test_GENERIC_mag_AppMain(void) {
  ...
  UT_CheckEvent_Setup(&EventTest, GENERIC_mag_PIPE_ERR_EID,
                      "GENERIC_mag: SB Pipe Read Error = %d");
  ...
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_mag_PIPE_ERR_EID generated (%u)",
...
void Test_GENERIC_mag_ProcessCommandPacket(void) {
  ...
  UtAssert_True(EventTest.MatchCount == 0,
                "GENERIC_mag_CMD_ERR_EID not generated (%u)",
                (unsigned int)EventTest.MatchCount);
  ...
  GENERIC_mag_ProcessCommandPacket();
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_mag_CMD_ERR_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
}
...
void Test_GENERIC_mag_ProcessGroundCommand(void) {
  ...
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_mag_CMD_NOOP_INF_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
  ...
  GENERIC_mag_ProcessGroundCommand();
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_mag_CMD_RESET_INF_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
...
void Test_GENERIC_mag_ReportHousekeeping(void) {
  ...
  UtAssert_True(MsgTimestamp ==
                    &GENERIC_mag_AppData.HkTelemetryPkt.TlmHeader.Msg,
...
void Test_GENERIC_mag_VerifyCmdLength(void) {
   ...
   */
  UtAssert_True(EventTest.MatchCount == 0,
                "GENERIC_mag_LEN_ERR_EID NOT generated (%u)",
                (unsigned int)EventTest.MatchCount);
   ...
   */
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_mag_LEN_ERR_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
}
 ...
 */
void Generic_mag_UT_Setup(void) { UT_ResetState(0); }
